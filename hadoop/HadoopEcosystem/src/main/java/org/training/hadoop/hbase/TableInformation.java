...
public class TableInformation {
  ...
  public static final String DELETED_TABLE_NAME = "scores1";
  ...
  public static void deleteTable(Configuration conf) throws IOException {
    Connection connection = ConnectionFactory.createConnection(conf);
    Admin admin = connection.getAdmin();
    if (admin.tableExists(TableName.valueOf(DELETED_TABLE_NAME))) {
...
//    TableInformation.deleteTable(TableInformation.getHBaseConfiguration());
  }
